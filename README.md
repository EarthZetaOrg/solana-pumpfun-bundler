# PumpFun Bundler with 24 wallets
Pump.fun bundler that launches token using pumpfun api and buy in the same block with 24 wallets using jito bundle technique.
